...
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_INTERACTIVESLZ)
extern struct cpufreq_governor cpufreq_gov_interactiveslz;
#define CPUFREQ_DEFAULT_GOVERNOR  (&cpufreq_gov_interactiveslz)
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_SMARTASS2)
extern struct cpufreq_governor cpufreq_gov_smartass2;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_smartass2)
#elif defined(CONFIG_CPU_FREQ_DEFAULT_GOV_SMARTASS2SE)
extern struct cpufreq_governor cpufreq_gov_smartass2se;
#define CPUFREQ_DEFAULT_GOVERNOR	(&cpufreq_gov_smartass2se)
